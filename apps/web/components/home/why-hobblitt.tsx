export function WhyHobblitt() {
  return (
    <section className="bg-[#111827] px-margin py-28 md:py-36">
      <div className="mx-auto max-w-screen-2xl">
        <div className="grid gap-16 lg:grid-cols-[0.7fr_1.3fr] lg:gap-24">
          ...
          <div>
            <p className="type-caption text-sm tracking-[0.15em] text-[#94A3B8]">
              DON&apos;T BRING US A BRIEF.
            </p>

            <h2 className="type-display mt-4 max-w-5xl text-5xl md:text-7xl lg:text-8xl">
            ...
            <p className="type-body mt-10 max-w-2xl text-base leading-8 text-[#94A3B8] md:text-lg">
              ...
              us. Tell us where you&apos;re stuck. We start by understanding —
              before assembling the right capabilities and building with you.
            </p>
